...
if(isset($_POST['new_pass'])){
    ...
    file_get_contents("http://patterns.local/second_web/apiClient.php?access_token=$token&method=change_pass&param=".$_POST['new_pass'].".".$_SESSION['uid']);
...
<div id="container" class="container">
    ...
    <div id="main-body">
        ...
        <br/>
        <br/>
        <h1>Hello <?php $user->get_fullname($uid); ?> <br> it is us Blue website!</h1>
        <br>
